...
@Component({
  ...
  templateUrl: './commands-master.html',
})
export class CommandsMaster implements OnInit {

  url = Apiendpoints.MASTER_COMMANDS;
  ...
  createUrl = Apiendpoints.MASTER_COMMOAND_CREATE;
  ...
  handleDeleteConfirm() {
    ...
    this.apiService
      .post(`${Apiendpoints.MASTER_COMMOAND_CREATE}`,{id:this.deleteId,status:3})
      .subscribe({
        next: () => {
